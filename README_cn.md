...
<p dir="ltr" style="font-size: 16px">一款基于 <a href="https://github.com/SagerNet/sing-box">Sing-box</a> 通用代理工具的跨平台代理客户端。Mela VPN 提供了较全面的代理功能，例如自动选择节点、TUN 模式、使用远程配置文件等。Mela VPN 无广告，并且代码开源。它为大家自由访问互联网提供了一个支持多种协议的、安全且私密的工具。</p>
...
[![Wiki上的所有教程](https://github.com/melavpn/melavpn-app/assets/125398461/95bb5cf8-c143-4934-87d6-b9d4c31e035e)](https://melavpn.com/app/)
...
您可以通过手动编辑位于 `/assets/translations` 中的 JSON 文件，或使用 [Inlang 在线编辑器](https://fink.inlang.com/editor/github.com/melavpn/melavpn-app)来改进现有语言或添加新语言。
...
我们的服务也需要经济支持。我们所有的活动都是志愿性质的，经济支持将被用于项目的发展。您可以在 [这里](https://melavpn.com/donation-and-support/) 查看我们的支持地址。

## 👩‍🏫 合作及联系信息

Mela VPN 是一个由社区驱动的项目。如果您有兴趣为本项目做出贡献，请阅读 [贡献指南](./CONTRIBUTING.md)。我们将非常感谢您，如果您能够在以下领域提供任何帮助：Flutter、Go、iOS 开发 (Swift)、Android 开发 (Kotlin)。
